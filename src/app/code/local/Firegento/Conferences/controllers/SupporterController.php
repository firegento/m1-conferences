...
class FireGento_Conferences_SupporterController extends Mage_Core_Controller_Front_Action
{
    /** @var array */
    ...
    public function listAction()
    {
        ...
        $supporterListModel = Mage::getModel('firegento_conferences/supporter');
        $supporterList      = $supporterListModel->getSupporterList($requestedSku);

        $supporterListBlock = Mage::app()
                                  ->getLayout()
                                  ->createBlock('firegento_conferences/api_supporter_list', 'mageuc.api.supporter_list');
